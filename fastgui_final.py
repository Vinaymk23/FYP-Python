...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        canvas = FigureCanvasTk(fig, self)
        canvas.draw()
...
ani=animation.FuncAnimation(fig,rep,fargs=[bars],interval=10, blit = False)   #animation function to plot data        
app.mainloop()